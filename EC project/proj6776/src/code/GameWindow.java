...
public class GameWindow extends JFrame
{
	...
	/* Create a GameWindow object by default. */
	public GameWindow()
	{
		this(STARTFS, null);
	}
	...
	private void createWindow(GameWindow old)
	{
		...
		t.setPreferredSize(new Dimension(720,600));
		setContentPane(t);
	...
	private void createFullscreenWindow(GameWindow old)
	{
		...
		try{
			...
			dev.setDisplayMode(new DisplayMode
					(700,600,32, DisplayMode.REFRESH_RATE_UNKNOWN));
		}catch(Throwable t){
	...
	public static GameWindow enterFullScreen(GameWindow win)
	{
		...
		try{
			...
			win.dev.setDisplayMode(new DisplayMode
					(720,600,32,DisplayMode.REFRESH_RATE_UNKNOWN));
